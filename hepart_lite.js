(function () {
    ...
    function getSearchData(params) {
        ...
        return fetch("https://www.copart.com/public/lots/number/search", {
            method: 'POST',
            headers: {
            ...
            getSearchData(params)
                ...
                .then((data) => {
                    ...
                    if (data.data && theData.length != 0) {
                        ...
                        var theLot = _.findWhere(theData, { lu: params.lu, ln: params.lotId });
                        if (theLot && theLot.fv) {
    ...
    function getLotinfoById() {
        ...
        if (lotId && !Number.isNaN(lotId)) {
            getStaticData(lotId)
                ...
                .then(data => {
                    getDuplicatesByVin({ vin: data.fv, lotId: lotId, lu: data.lu });
